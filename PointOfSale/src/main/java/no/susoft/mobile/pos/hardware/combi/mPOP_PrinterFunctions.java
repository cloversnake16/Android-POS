...
public class mPOP_PrinterFunctions {
    ...
    public static byte[] createCommandsEnglish2inchLineModeReceipt() {
        ...
        commands.add(0x1b, 0x1d, 0x61, 0x01);               // Alignment(center)
        commands.add(0x1b, 0x62, 0x06, 0x02, 0x02, 0x20).add("mPOP").add(0x1e);   // Code 128 BarCode
        commands.add("\r\n");
    ...
    static byte[] createCommandsEnglishRasterModeCoupon( int width, SCBBitmapConverter.Rotation rotation, Resources resource ) {
        mPOP_CommandDataList commands = new mPOP_CommandDataList();

        //Bitmap bitmap = BitmapFactory.decodeResource( resource, R.drawable.coupon_image);
