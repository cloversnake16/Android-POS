...
public class DrawerLayoutInstaller {
    ...
    public static class DrawerBuilder {
        ...
        private int drawerLockMode = DrawerLayout.LOCK_MODE_UNLOCKED;
        ...
        public DrawerBuilder drawerLockMode(int lockMode) {
        ...
        private DrawerLayout createDrawerLayout() {
            if (drawerRootResId != 0) {
                ...
                final ViewGroup.LayoutParams leftDrawerParams = new DrawerLayout.LayoutParams((int) (drawerWidth * Resources.getSystem().getDisplayMetrics().density), ViewGroup.LayoutParams.MATCH_PARENT, Gravity.START);
        ...
        private void addDrawerToActivity(DrawerLayout drawerLayout) {
            ...
            drawerContentRoot.addView(contentView, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));

            rootView.addView(drawerLayout, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        }
        ...
        private void setupDrawerLeftView(DrawerLayout drawerLayout) {
            if (drawerLeftView != null) {
                ((ViewGroup) drawerLayout.getChildAt(1)).addView(drawerLeftView, new DrawerLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
            }
        }
    }
}